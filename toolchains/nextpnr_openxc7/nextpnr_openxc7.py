...
def _collect_sv_sources(repo, peripherals, user_lab_top, generated_top):
    """Same as the icestorm/trellis drivers — gate helper inclusion by
    module-name match to avoid yosys 0.36 SV-feature gaps from breaking
    unrelated designs."""
    ...
    # Skip _quartus_compat: yosys synth_xilinx provides BUFG natively.
