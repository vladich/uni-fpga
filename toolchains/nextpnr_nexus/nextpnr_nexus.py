...
def _collect_sv_sources(repo, peripherals, user_design_top, generated_top):
    """Same module-name-gating pattern as the apicula driver. synth_nexus
    is yosys's native flow for LIFCL/LFD2NX, so we don't add the
    _quartus_compat BUFG/IBUFG stubs."""
