...
def _collect_sv_sources(repo, peripherals, user_lab_top, generated_top):
    """Same module-name-gating pattern as the apicula driver — synth_gatemate
    is yosys's native flow, so we don't add the _quartus_compat BUFG/IBUFG
    stubs (yosys handles GateMate's CC_BUFG/CC_PLL natively)."""
