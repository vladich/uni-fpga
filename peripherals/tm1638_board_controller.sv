...
(
    ...
    ////////////// TM1563 data /////////////////
    // Flat 1-D representation (was multi-dim packed: yosys 0.36 doesn't
    // accept that in declarations). hex[i*w_seg +: w_seg] gives the
    // segment data for digit `i`; hex[i*w_seg + j] is segment-j of digit-i.
    wire [w_digit * w_seg - 1:0] hex;
        ...
        if (reset_syn2) begin
            ...
            if (counter[0] && ~busy) begin
                ...
                case (instruction_step)
                    ...
                    19: display_digit({hex[7*w_seg+0],hex[6*w_seg+0],hex[5*w_seg+0],hex[4*w_seg+0],hex[3*w_seg+0],hex[2*w_seg+0],hex[1*w_seg+0],hex[0*w_seg+0]});
                    20: display_digit(8'b00000000);
                    21: display_digit({hex[7*w_seg+1],hex[6*w_seg+1],hex[5*w_seg+1],hex[4*w_seg+1],hex[3*w_seg+1],hex[2*w_seg+1],hex[1*w_seg+1],hex[0*w_seg+1]});
                    22: display_digit(8'b00000000);
                    23: display_digit({hex[7*w_seg+2],hex[6*w_seg+2],hex[5*w_seg+2],hex[4*w_seg+2],hex[3*w_seg+2],hex[2*w_seg+2],hex[1*w_seg+2],hex[0*w_seg+2]});
                    24: display_digit(8'b00000000);
                    25: display_digit({hex[7*w_seg+3],hex[6*w_seg+3],hex[5*w_seg+3],hex[4*w_seg+3],hex[3*w_seg+3],hex[2*w_seg+3],hex[1*w_seg+3],hex[0*w_seg+3]});
                    26: display_digit(8'b00000000);
                    27: display_digit({hex[7*w_seg+4],hex[6*w_seg+4],hex[5*w_seg+4],hex[4*w_seg+4],hex[3*w_seg+4],hex[2*w_seg+4],hex[1*w_seg+4],hex[0*w_seg+4]});
                    28: display_digit(8'b00000000);
                    29: display_digit({hex[7*w_seg+5],hex[6*w_seg+5],hex[5*w_seg+5],hex[4*w_seg+5],hex[3*w_seg+5],hex[2*w_seg+5],hex[1*w_seg+5],hex[0*w_seg+5]});
                    30: display_digit(8'b00000000);
                    31: display_digit({hex[7*w_seg+6],hex[6*w_seg+6],hex[5*w_seg+6],hex[4*w_seg+6],hex[3*w_seg+6],hex[2*w_seg+6],hex[1*w_seg+6],hex[0*w_seg+6]});
                    32: display_digit(8'b00000000);
                    33: display_digit({hex[7*w_seg+7],hex[6*w_seg+7],hex[5*w_seg+7],hex[4*w_seg+7],hex[3*w_seg+7],hex[2*w_seg+7],hex[1*w_seg+7],hex[0*w_seg+7]});
                    34: display_digit(8'b00000000);
                    `else
                    19: display_digit(hex[7*w_seg +: w_seg]); // Digit 1
                    20: display_led(3'd7);        // LED 8

                    21: display_digit(hex[6*w_seg +: w_seg]); // Digit 2
                    22: display_led(3'd6);        // LED 7

                    23: display_digit(hex[5*w_seg +: w_seg]); // Digit 3
                    24: display_led(3'd5);        // LED 6

                    25: display_digit(hex[4*w_seg +: w_seg]); // Digit 4
                    26: display_led(3'd4);        // LED 5

                    27: display_digit(hex[3*w_seg +: w_seg]); // Digit 5
                    28: display_led(3'd3);        // LED 4

                    29: display_digit(hex[2*w_seg +: w_seg]); // Digit 6
                    30: display_led(3'd2);        // LED 3

                    31: display_digit(hex[1*w_seg +: w_seg]); // Digit 7
                    32: display_led(3'd1);        // LED 2

                    33: display_digit(hex[0*w_seg +: w_seg]); // Digit 8
