...
//
// This file defines the canonical port list every user-written `lab_top`
...
// the lab requires more than the board provides, surface the mismatch.
//
// To write a new lab, copy the body of this file into your project as
// `lab_top.sv` and add your logic. Never rename the ports or change their
